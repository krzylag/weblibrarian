...
class WEBLIB_Patrons_Admin extends WP_List_Table {
  ...
  function __construct() {
     ...
     $screen_id =  add_submenu_page('weblib-list-patrons',__('Add Library Patron','web-librarian'),
     ...
     $screen_id =  add_submenu_page('weblib-list-patrons',__('Add Bulk Library Patrons','web-librarian'),
  ...
  function add_per_page_option() {
    ...
    $args['label'] = __('Patrons','web-librarian');
    $args['default'] = 20;
